...
<?php
   ...
   class MiaNagiosPlugin_CheckWindowNetworkBwin extends MiaNagiosPluginSNMPIndexed{        
      /**
       * (non-PHPdoc)
       * @see nagios/plugins/lib/MiaNagiosPlugin#setSpecialProperties()
       */
      protected function setSpecialProperties(){
         $this->setSpecialProperty('intituleStatus','WINDOWS_NETWORK_BWIN');
         $this->setSpecialProperty('titre_aide','Plugins Nagios de débit entrant  d\'un serveur windows');
      ...
      protected function setIndicators(){         
         $this->addIndicatorSnmpIndexed('iftable_network_bwin','.1.3.6.1.2.1.2.2.1.1','.1.3.6.1.2.1.2.2.1.10','.1.3.6.1.2.1.2.2.1.1');
         $this->setIndicatorMin('iftable_network_bwin',0);
         $this->setIndicatorCounter('iftable_network_bwin',32);
         $this->setIndicatorTimeDerived('iftable_network_bwin');
   ...
   $check=new MiaNagiosPlugin_CheckWindowNetworkBwin();
   $check->OutputResult();